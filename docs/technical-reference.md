...
|---|---|
| ![MRMS composite reflectivity across the continental US](shots/mrms.jpg) | ![Accumulated rainfall across the Southeast](shots/qpe.jpg) |
...
![Base reflectivity from six radars composited across the southern Plains](shots/mosaic.jpg)
...
![HookEcho on Android replaying the Moore, Oklahoma tornado of 20 May 2013](shots/android/hero.gif)
...
| | |
|---|---|
| ![The map, with the search pill, the control column and the scrubber floating over it](shots/android/map.jpg) | ![The layers and tools sheet](shots/android/layers.jpg) |
...
| ![Alerts in view, listed in the sheet](shots/android/alerts.jpg) | ![The radar site picker, nearest first](shots/android/site.jpg) |
