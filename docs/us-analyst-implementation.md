...
| K case/chase | Partial | GPS, packs, sharing, archive replay, versioned portable case manifests with exact radar object identities and cross-platform import/export | Pending routing exposure and case reports |
