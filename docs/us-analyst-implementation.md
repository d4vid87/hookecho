...
| D satellite/GLM | Partial | GLM flashes and registry-backed flash-extent density; native ABI C13 clean IR and C08 water-vapor acquisition, fixed-grid navigation, quality masking, native sampling, and display rendering | Real GOES-19 C13 mesoscale fixture passes value, DQF, timestamp, forward/inverse projection, native sample, and display-frame checks; visible channels, animation, RGB, and offline packs pending |
