...
| B operational radar | Partial | AWS live-chunk provider adapter with existing complete-volume archive fallback, progressive merge, six moments | Pending provider/failover fixture gate |
