...
| F model workstation | Partial | shared HRRR/RAP/NAM/NBM acquisition definitions, range-index decoder, registered fields, global fields, and comparisons | Pending forecast schedules, vertical mappings, additional deterministic/ensemble adapters, and ensemble gate |
