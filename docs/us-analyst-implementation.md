...
| B operational radar | Partial | AWS live-chunk provider adapter with existing complete-volume archive fallback, progressive merge, six moments, VCP/cut/radial/latency telemetry | Pending provider/failover fixture gate |
