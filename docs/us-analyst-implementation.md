...
| F model workstation | Partial | shared HRRR/RAP/RRFS/NAM/NBM/GFS/ECMWF source and schedule definitions, range-index decoders, registered fields, global fields, and comparisons; RRFS v1 parallel is selectable for environment fields and contract-checked in scheduled CI | Live RRFS CAPE range-read/decode covers 1,088,905 finite cells; pending vertical mappings, REFS/GEFS adapters, ensemble products, and ensemble gate |
