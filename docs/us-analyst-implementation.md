...
| E MRMS catalog | Partial | registry-backed operational subset in `mrms.rs`, including low-level reflectivity, low/mid-level AzShear, MESH/POSH, and gauge-corrected 1/3/6/12/24-hour QPE; public prefixes and freshness are checked by scheduled CI, and product sentinel values are normalized before sampling | Descriptor coverage, missing-value, and official feed-contract tests pass; broader catalog pending |
