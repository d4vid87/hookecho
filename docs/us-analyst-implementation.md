...
| D satellite/GLM | Partial | GLM flashes and registry-backed flash-extent density; native ABI CMIP decoder preserves CMI, DQF, band/time/source metadata and official fixed-grid navigation | Real GOES-19 C13 mesoscale fixture passes value, DQF, timestamp, off-disk and known-coordinate projection checks; acquisition/rendering pending |
