...
| D satellite/GLM | Partial | GLM flashes and registry-backed flash-extent density; native ABI C13 acquisition, fixed-grid navigation, quality masking, native sampling, and display rendering | Real GOES-19 C13 mesoscale fixture passes value, DQF, timestamp, forward/inverse projection, native sample, and display-frame checks; more channels, animation, RGB, and offline packs pending |
