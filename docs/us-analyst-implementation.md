...
| F model workstation | Partial | shared HRRR/RAP/NAM/NBM/GFS/ECMWF source and schedule definitions, range-index decoders, registered fields, global fields, and comparisons | Pending vertical mappings, additional deterministic/ensemble adapters, and ensemble gate |
