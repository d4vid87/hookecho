...
| H workspaces | Partial | workspaces, 1/2/4 pane layouts, camera/time link groups, and a geographic cursor projected across linked panes | Workspace compatibility tests pass; synchronized native-value readout and resource gate remain pending |
