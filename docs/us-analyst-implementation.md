...
| E MRMS catalog | Partial | registry-backed operational subset in `mrms.rs`, including gauge-corrected 1/3/6/24-hour QPE windows whose public prefixes are checked by scheduled CI | Descriptor coverage and official-prefix contract tests pass; broader catalog pending |
