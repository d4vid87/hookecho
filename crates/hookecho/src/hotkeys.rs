...
pub const DEFAULTS: &[Binding] = &[
    Binding {
        key: egui::Key::Num1,
        action: Action::Product(Moment::Reflectivity),
    },
    Binding {
        key: egui::Key::Num2,
        action: Action::Product(Moment::Velocity),
    },
    Binding {
        key: egui::Key::Num3,
        action: Action::Product(Moment::SpectrumWidth),
    },
    Binding {
        key: egui::Key::Num4,
        action: Action::Product(Moment::DifferentialReflectivity),
    },
    Binding {
        key: egui::Key::Num5,
        action: Action::Product(Moment::DifferentialPhase),
    },
    Binding {
        key: egui::Key::Num6,
        action: Action::Product(Moment::CorrelationCoefficient),
    },
    Binding {
        key: egui::Key::PageUp,
        action: Action::TiltUp,
    },
    Binding {
        key: egui::Key::PageDown,
        action: Action::TiltDown,
    },
    Binding {
        key: egui::Key::F3,
        action: Action::OpenSiteDialog,
    },
    Binding {
        key: egui::Key::F5,
    ...
    Binding {
        key: egui::Key::F8,
        action: Action::ToggleObs,
    },
    Binding {
        key: egui::Key::F9,
        action: Action::ToggleObsTour,
    },
    Binding {
        key: egui::Key::R,
        action: Action::InstantReplay,
    },
];
